...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <a href="/">
        <div className="max-sm:hidden cursor-pointer flex items-center gap-2 px-8 py-4 rounded-2xl">
            <Image 
              src="/rini 2.png"
              alt="Logo"
              width={100}
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute right-[6rem] top-full flex justify-center")}>
